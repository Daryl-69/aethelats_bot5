...
Uses:
  - ChromaDB DefaultEmbeddingFunction (onnxruntime, no PyTorch needed)
...
def build_store():
    ...
    # DefaultEmbeddingFunction uses onnxruntime (all-MiniLM-L6-v2 quantized)
    # No PyTorch required — works on Python 3.13 and HF Spaces free tier
